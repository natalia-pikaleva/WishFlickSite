...
const UsersListPage: React.FC = () => {
  ...
  const handleAddFriend = (userId: number) => {
    // Здесь реализуйте вызов API для добавления в друзья
    // Для демонстрации обновим локально состояние
    setUsers(users =>
      users.map(u =>
            ...
            >
              ...
              {user.isFriend ? (
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-1 bg-gradient-to-r from-purple-500 to-teal-400 text-white rounded-lg font-medium hover:from-purple-600 hover:to-teal-500 transition-all duration-200 ml-4"
                >
